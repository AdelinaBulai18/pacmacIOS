//
//  TurfRunnerViewController.m
//  ZamboniRun
//
//  Created by Laurentiu on 02/06/15.
...
@interface TurfRunnerViewController ()

@end

@implementation TurfRunnerViewController
{
        //GAME SCREEN
    ...
    - (void)viewDidLoad {
        ...
        mazeImage.image = [UIImage imageNamed:@"football-bg-Turf.png"];
        ...
        mapArray = [NSArray arrayWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"TurfMap" ofType:@"plist"]];
        ...
        for (int counterLine = 0; counterLine < mapArray.count; counterLine++) {
            ...
            for (int counterCollumn = 0; counterCollumn < lineArray.count; counterCollumn++) {
                ...
                if(puckOnIt == YES){
                    ...
                    puckImage.image = [UIImage imageNamed:@"football-football@2x.png"];
                    ...
                    puckImage.frame = CGRectMake(xPos, yPos, width, height);
        ...
        player.image = [UIImage imageNamed:@"football-player@2x.png"];
        ...
        zombieZomboni1.image = [UIImage imageNamed:@"football-enemy@2x.png"];
        ...
        zombieZomboni2.image = [UIImage imageNamed:@"football-enemy@2x.png"];
        ...
        zombieZomboni3.image = [UIImage imageNamed:@"football-enemy@2x.png"];
        ...
        playGameButtonBackgrounImage.image = [UIImage imageNamed:@"football-bg-Turf.png"];
        ...
        playGameButtonBackgrounPLayerImage.image = [UIImage imageNamed:@"football-collect@2x.png"];
        ...
        bkImage.image = [UIImage imageNamed:@"football-welcome_bg.png"];
        ...
        [playButton setBackgroundImage:[UIImage imageNamed:@"football-play@2x.png"] forState:UIControlStateNormal];
        ...
        [howToButton setBackgroundImage:[UIImage imageNamed:@"football-how@2x.png"] forState:UIControlStateNormal];
        ...
        backgroundImage.image = [UIImage imageNamed:@"football-bg-01.png"];
        ...
        scoreBackgroundImage.image = [UIImage imageNamed:@"football-score@2x.png"];
        ...
        [tryAgainButton setBackgroundImage:[UIImage imageNamed:@"football-try_again@2x.png"] forState:UIControlStateNormal];
        ...
        shareImage.image = [UIImage imageNamed:@"football-share@2x.png"];
        ...
        howToScreenBackground.image = [UIImage imageNamed:@"football-bg-01.png"];
        ...
        howToImage.image = [UIImage imageNamed:@"football-howto@2x.png"];
        ...
        [lbName setText:@"Pacman Football"];
...
-(void)btnBackPress:(id)sender
{
    ...
    - (void)displayEndGameScreen{
        ...
        NSString *bestScore = [defaults objectForKey:@"bestScoreTurfRunnerViewController"];
        if(bestScore != nil)
        {
            ...
            if(current > score)
            {
                ...
                [defaults setObject:currentString forKey:@"bestScoreTurfRunnerViewController"];
            }
        }
        else
        {
        ...
        NSString *best = [defaults objectForKey:@"bestScoreTurfRunnerViewController"];
    ...
    - (void)startGameButtonFunstion{
        ...
        [self playSound:@"008748943-footballpractice" andVolume:1.f andNumberOfTimes:-1 andAudioFormat:@"wav"];
    ...
    - (void)southZombieMovement:(UIImageView *)zombie onPath:(NSArray *)zombiePath andCounter:(int)counterZombie{
        ...
        [UIView animateWithDuration:0.2f
                         ...
                         completion:^(BOOL finished){
                             ...
                             {
                                 [self playSound:@"0047_football_drop" andVolume:1.f andNumberOfTimes:0 andAudioFormat:@"wav"];
                                 ...
                                 if (![(NSString *)[[[mapArray objectAtIndex:playerYPos] objectAtIndex:playerXPos] objectForKey:@"gearOnIt"]  isEqualToString: @"NO"]) {
                                     ...
                                     if (gearImageViewRecconstructor.hidden == NO) {
                                         ...
                                         if (gearParts == 7) {
                                             ...
                                             [self playSound:@"006141998-football-crowd-touchdown-02-lo" andVolume:1.f andNumberOfTimes:0 andAudioFormat:@"wav"];
                                             [self displayEndGameScreen];
                                         }
                                     }
                                 }
